...
print('p(jury | the): {}'.format(round(probs[word_index_dict['all'], word_index_dict['the']], 5)))
print('p(jury | the): {}'.format(round(probs[word_index_dict['the'], word_index_dict['jury']], 5)))
print('p(campaign | the): {}'.format(round(probs[word_index_dict['the'], word_index_dict['campaign']], 5)))
print('p(calls | anonymous): {}'.format(round(probs[word_index_dict['anonymous'], word_index_dict['calls']], 5)))
...
file_write = open('bigram_eval.txt', 'w')
